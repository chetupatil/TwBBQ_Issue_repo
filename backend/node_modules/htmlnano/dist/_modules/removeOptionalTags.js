...
function removeOptionalTags(tree) {
    tree.forEach((node, index)=>{
         ...
         */ if (node.tag === 'html') {
            ...
            if (typeof firstChildNode === 'string' && helpers.isComment(firstChildNode)) {
                isHtmlStartTagCanBeOmitted = false;
            }
            if (typeof nextNode === 'string' && helpers.isComment(nextNode)) {
         ...
         */ if (node.tag === 'head') {
            ...
            if (nextNode && typeof nextNode === 'string' && (startWithWhitespacePattern.test(nextNode) || helpers.isComment(nextNode))) {
         ...
         */ if (node.tag === 'body') {
            ...
            if (typeof firstChildNode === 'string' && startWithWhitespacePattern.test(firstChildNode) || typeof firstChildNode === 'string' && helpers.isComment(firstChildNode)) {
            ...
            if (nextNode && typeof nextNode === 'string' && helpers.isComment(nextNode)) {
