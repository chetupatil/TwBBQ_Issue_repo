...
var _modules_collapseAttributeWhitespace = require('./collapseAttributeWhitespace.js');
var sortAttributesShared = require('../sortAttributesShared-erzzz2xz.js');
...
/** Sort values inside list-like attributes (e.g. class, rel) */ const mod = {
    default (tree, options, moduleOptions) {
        const sortType = sortAttributesShared.resolveSortType(moduleOptions);
...
function walkListAttributes(tree, walkFn) {
    tree.walk((node)=>{
        ...
        Object.entries(node.attrs).forEach(([attrName, attrValues])=>{
            ...
            if (!_modules_collapseAttributeWhitespace.isListAttribute(attrNameLower, tagName) || typeof attrValues !== 'string') {
                return;
            }
