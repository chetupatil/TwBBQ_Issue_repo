...
// when — they apply.
const isolatedScopeTags = new Set([
    'noscript',
    'template'
]);
function isIsolatedScope(node) {
    return typeof node === 'object' && typeof node.tag === 'string' && isolatedScopeTags.has(node.tag);
}
...
export { isIsolatedScope as i, normalizeAttrsForKey as n };
