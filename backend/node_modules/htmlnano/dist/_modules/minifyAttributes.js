...
function minifyAttributeWhitespace(mode, attrName, attrValue, tagName) {
    ...
    if (_modules_collapseAttributeWhitespace.isListAttribute(attrNameLower, tagName)) {
    ...
    if (_modules_collapseAttributeWhitespace.isSingleValueAttribute(attrNameLower, tagName)) {
        const trimmed = attrValue.trim();
        return trimmed === attrValue ? null : trimmed;
    }
    if (mode === 'aggressive') {
